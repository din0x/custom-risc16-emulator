...
typedef enum : uint8_t {
    ...
    OPCODE_LD = 0x10, OPCODE_ST = 0x11,

    OPCODE_ADD = 0x12, OPCODE_SUB = 0x13, OPCODE_MUL = 0x14, OPCODE_DIV = 0x15, OPCODE_MOD = 0x16,
    OPCODE_OR = 0x17, OPCODE_XOR = 0x18, OPCODE_AND = 0x19, OPCODE_NAND = 0x1a,

    OPCODE_BREQ = 0x20, OPCODE_BRGT = 0x21, OPCODE_BRLT = 0x22, OPCODE_BRNE = 0x23,
